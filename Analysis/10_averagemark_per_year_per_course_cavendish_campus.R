...
averagemark.per.year.by.course.plot <-
  ...
  labs(title="Average mark per year for courses at Cavendish campus",
...
#save plot as png
save_plot(averagemark.per.year.by.course.plot, 700, 840, "averagemark_per_year_per_course_Cavendish.png",
