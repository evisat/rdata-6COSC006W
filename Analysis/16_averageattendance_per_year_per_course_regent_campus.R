...
averageattendance.per.year.by.course.plot <-
  ...
  labs(title="Average attendance per year for courses at Regent Campus",
...
#save plot as png
save_plot(averageattendance.per.year.by.course.plot, 700, 840, "averageattendance_per_year_per_course_Regent.png")
