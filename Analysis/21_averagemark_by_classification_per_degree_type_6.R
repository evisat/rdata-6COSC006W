...
Ba.waffle.plot <- waffle(waffle.data.BA, rows = 55) +
  labs(title = "Average Classifications of BA Students in study year6", fill='Classification type') +
  theme(plot.title = element_text(size = 27),
        legend.text = element_text(size = 20, margin = margin(t = 0, r = 0, b = 5, l = 0, unit = "pt")))

#save plot as png
save_plot(Ba.waffle.plot, 1000, 940, "averagemark_classifications_BA_year6.png")
...
BMus.waffle.plot <- waffle(waffle.data.BMus, rows = 8) +
  labs(title = "Average Classifications of BMus Students in study year6", fill='Classification type') +
  theme(plot.title = element_text(size = 27),
        legend.text = element_text(size = 20, margin = margin(t = 0, r = 0, b = 5, l = 0, unit = "pt")))

#save plot as png
save_plot(BMus.waffle.plot, 1000, 940, "averagemark_classifications_BMus_year6.png")
...
BEng.waffle.plot <- waffle(waffle.data.BEng, rows = 5) +
  labs(title = "Average Classifications of BEng Students in study year6", fill='Classification type') +
  theme(plot.title = element_text(size = 27),
        legend.text = element_text(size = 20, margin = margin(t = 0, r = 0, b = 5, l = 0, unit = "pt")))

#save plot as png
save_plot(BEng.waffle.plot, 1000, 940, "averagemark_classifications_BEng_year6.png")
...
LLB.waffle.plot <- waffle(waffle.data.LLB, rows = 15) +
  labs(title = "Average Classifications of LLB Students in study year6", fill='Classification type') +
  theme(plot.title = element_text(size = 27),
        legend.text = element_text(size = 20, margin = margin(t = 0, r = 0, b = 5, l = 0, unit = "pt")))

#save plot as png
save_plot(LLB.waffle.plot, 1000, 940, "averagemark_classifications_LLB_year6.png")
...
BSc.waffle.plot <- waffle(waffle.data.BSc, rows = 40) +
  labs(title = "Average Classifications of BSc Students in study year6", fill='Classification type') +
  theme(plot.title = element_text(size = 27),
        legend.text = element_text(size = 20, margin = margin(t = 0, r = 0, b = 5, l = 0, unit = "pt")))

#save plot as png
save_plot(BSc.waffle.plot, 1000, 940, "averagemark_classifications_BSc_year6.png")
