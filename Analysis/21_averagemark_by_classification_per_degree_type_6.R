...
Ba.waffle.plot <- waffle(waffle.data.BA, rows = 55) +
  labs(title = "Average classifications of BA students in level 6", fill='Classification type') +
  theme(plot.title = element_text(face = "bold", size = 24),
        legend.text = element_text(size = 20, margin = margin(t = 0, r = 0, b = 5, l = 0, unit = "pt")),
        plot.margin=unit(c(1,1,1.5,1.2),"cm"))

#save plot as png
save_plot(Ba.waffle.plot, 1000, 940, "averagemark_classifications_BA_level6.png",
...
BMus.waffle.plot <- waffle(waffle.data.BMus, rows = 8) +
  labs(title = "Average classifications of BMus students in level 6", fill='Classification type') +
  theme(plot.title = element_text(face = "bold", size = 24),
        legend.text = element_text(size = 20, margin = margin(t = 0, r = 0, b = 5, l = 0, unit = "pt")),
        plot.margin=unit(c(1,1,1.5,1.2),"cm"))

#save plot as png
save_plot(BMus.waffle.plot, 1000, 940, "averagemark_classifications_BMus_level6.png",
...
BEng.waffle.plot <- waffle(waffle.data.BEng, rows = 5) +
  labs(title = "Average classifications of BEng students in level 6", fill='Classification type') +
  theme(plot.title = element_text(face = "bold", size = 24),
        legend.text = element_text(size = 20, margin = margin(t = 0, r = 0, b = 5, l = 0, unit = "pt")),
        plot.margin=unit(c(1,1,1.5,1.2),"cm"))

#save plot as png
save_plot(BEng.waffle.plot, 1000, 940, "averagemark_classifications_BEng_level6.png",
...
LLB.waffle.plot <- waffle(waffle.data.LLB, rows = 15) +
  labs(title = "Average classifications of LLB students in level 6", fill='Classification type') +
  theme(plot.title = element_text(face = "bold", size = 24),
        legend.text = element_text(size = 20, margin = margin(t = 0, r = 0, b = 5, l = 0, unit = "pt")),
        plot.margin=unit(c(1,1,1.5,1.2),"cm"))

#save plot as png
save_plot(LLB.waffle.plot, 1000, 940, "averagemark_classifications_LLB_level6.png",
...
BSc.waffle.plot <- waffle(waffle.data.BSc, rows = 40) +
  labs(title = "Average classifications of BSc students in level 6", fill='Classification type') +
  theme(plot.title = element_text(face = "bold", size = 24),
        legend.text = element_text(size = 20, margin = margin(t = 0, r = 0, b = 5, l = 0, unit = "pt")),
        plot.margin=unit(c(1,1,1.5,1.2),"cm"))

#save plot as png
save_plot(BSc.waffle.plot, 1000, 940, "averagemark_classifications_BSc_level6.png", 
